...
// TODO(post-1.0): move retry-with-backoff to app.js where
// this.homey.setTimeout provides lifecycle-tracked timers. This native
// setTimeout works fine since each retry-wait is bounded (≤9s) and the
// loop awaits sequentially, but app-lifecycle teardown during a retry
// would leave the timer dangling for that bounded duration.
